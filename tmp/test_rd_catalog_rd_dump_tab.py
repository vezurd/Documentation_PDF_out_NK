...
from rd_catalog.rd_dump_index import CANON_HEADER, RD_DUMP_HEADERS
...
def main() -> None:
    ...
    assert visible == ["01", "01-AN01"], visible
    table = tab.table()
    ...
    assert canon == ["нет"], canon
    assert _visible_revisions(tab) == ["01"]
