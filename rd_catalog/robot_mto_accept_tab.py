...
class RobotMtoAcceptDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        intro = QLabel(
            "Синий текст в «Робот МТО · рев.» означает ручное "
            "подтверждение относительно MTO официальной папки РД. "
            "Это не копия по дате и не сверка байтов. "
            "Имя файла робота не меняется."
        )
...
class RobotMtoAcceptTab(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        hint = QLabel(
            "Подтверждённые правки MTO робота относительно эталона "
            "официальной папки РД. «актуально» — синий текст в Комплектах; "
            "«устарело» — сменился эталон РД; «нет файла» — другой файл робота."
        )
